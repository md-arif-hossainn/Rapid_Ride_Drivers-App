...
class _NewTripPageState extends State<NewTripPage>
{
  ...
  obtainDirectionAndDrawRoute(sourceLocationLatLng, destinationLocationLatLng) async
  {
    ...
    print("------------sourceLocationLatLng-----$sourceLocationLatLng------destinationLocationLatLng-----$destinationLocationLatLng");
    showDialog(
    ...
    print("------------TRIP DETAILS iNFO-----------------$tripDetailsInfo----------------------------------");
    ...
    List<dynamic> encodedPoints = tripDetailsInfo!.encodedPoints!;
    print("This is LatLan: $encodedPoints");


    List<LatLng> latLngPointsFromPickUpToDestination = encodedPoints.map((point) {
    ...
    {
      latLngPointsFromPickUpToDestination.forEach((LatLng latLngPoint)
      {
        coordinatesPolylineLatLngList.add(LatLng(latLngPoint.latitude, latLngPoint.longitude));
      });
      print("-----------coordinatesPolylineLatLngList-------------------$coordinatesPolylineLatLngList-------------------");
    }
  ...
  updateTripDetailsInformation() async
  {
    if(!directionRequested)
    {
      ...
      if(directionDetailsInfo != null)
      {
        ...
        setState(() {
          durationText = directionDetailsInfo.driveTime!.toString();
          distanceText = directionDetailsInfo.distance!.toString();
        });
      }
    }
  }
